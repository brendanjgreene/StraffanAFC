...
urlpatterns = [
    ...
    url(r'^subject/(?P<subject_id>\d+)/$', news_views.subject, name='subjects'),
    url(r'^subject/new/$', news_views.new_subject, name='new_subject'),
    url(r'^subject/edit/(?P<subject_id>\d+)/$', news_views.edit_subject, name='edit_subject'),
    url(r'^subject/delete/(?P<id>\d+)/$', news_views.delete_subject, name='delete_subject'),
    url(r'^story/new/(?P<subject_id>\d+)/$', news_views.new_story, name='new_story'),
    url(r'^story/(?P<thread_id>\d+)/$', news_views.story, name='story'),
    url(r'^story/edit/(?P<thread_id>\d+)/$', news_views.edit_story, name='edit_story'),
    url(r'^story/delete/(?P<thread_id>\d+)/$', news_views.delete_story, name='delete_story'),
